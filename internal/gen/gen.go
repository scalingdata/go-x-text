...
package gen // import "github.com/scalingdata/go-x-text/internal/gen"
...
func localReadmeFile() string {
	p, err := build.Import("github.com/scalingdata/go-x-text", "", build.FindOnly)
	if err != nil {
...
const readmeTxt = `Generated by github.com/scalingdata/go-x-text/internal/gen. DO NOT EDIT.

This directory contains downloaded files used to generate the various tables
in the github.com/scalingdata/go-x-text subrepo.
