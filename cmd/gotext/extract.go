	...
	for _, info := range iprog.InitialPackages() {
		for _, f := range info.Files {
			...
			ast.Inspect(f, func(n ast.Node) bool {
				...
				// "github.com/scalingdata/go-x-text/message".Printer.
...
// TODO: use the types in conf.Import("github.com/scalingdata/go-x-text/message") to extract
// the correct instances.
var extractFuncs = map[string]map[string]int{
	// TODO: Printer -> *github.com/scalingdata/go-x-text/message.Printer
	"message.Printer": {
		"Printf":  0,
		"Sprintf": 0,
		"Fprintf": 1,
