...
package utf32 // import "github.com/scalingdata/go-x-text/encoding/unicode/utf32"
...
const (
	...
	// Consistent with BOMPolicy definition in github.com/scalingdata/go-x-text/encoding/unicode
)
